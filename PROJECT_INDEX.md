...
- **Exports**: `init_sentry()`
- **Purpose**: Sentry SDK初期化。40種類の機密キー自動スクラブ。httpx統合。
...
### Coverage Metrics
- **Current Coverage**: 95.43%（unit+integration条件）
...
- **sentry-sdk[httpx]** (>=2.60.0,<3.0.0): エラー監視（httpx統合）
...
- **機密情報スクラブ**: 40種類のキー（API_KEY, PASSWORD等）自動除外
...
| Metric | Value | Target |
|--------|-------|--------|
| Test Coverage | 95.43% | 85% (Week 5-6) |
| Test Files | 19 | - |
| Python Version | 3.14 | - |
